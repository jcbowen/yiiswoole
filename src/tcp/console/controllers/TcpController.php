...
class TcpController extends Controller
{
    ...
    public function init()
    {
        ...
        if (!($this->server)) {
            ...
            $onServer = null;
            if (!empty($this->onServer)) {
                if (class_exists($this->onServer)) {
                    $onServer = new $this->onServer();
                }
            }
            $this->server = new $this->serverClass($this->config, $this->ports, $onServer, $this->tables);
        }
    }
